...
public interface FriendsDao {
	...
	@Select("select url,time,context,type,topic from weiboandtianya inner join wturl wt on wt.weibourl=url or wt.tianyaurl=url and wt.friendname=friendname order by time desc limit 100")
